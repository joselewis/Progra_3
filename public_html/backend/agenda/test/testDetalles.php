...
$obj_persona->setNombre("Guillermo");
$obj_persona->setApellido1("Piedra");
$obj_persona->setApellido2("Solis");
$obj_persona->setSexo(1);
$obj_persona->setObservaciones("Inscripcion");
$obj_persona->setFecNacimiento("19850130");
$obj_persona->setLastUser("memopiedra121");
